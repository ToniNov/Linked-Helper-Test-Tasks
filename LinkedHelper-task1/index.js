...
function sostavChisla(massivChisel, chislo) {
    const sortedArr = massivChisel.sort((a, b) => a - b);
    const results = [];
    const part = [];
    let sum = 0;

    if (!sortedArr.length || sortedArr[0] > chislo) {
        return results;
    }
    sortedArr.push(chislo + 1);
...
// console.log("99", sostavChisla ([8, 2, 3, 4, 6, 7, 1], 99));
// console.log("15", sostavChisla([7, 8, 3, 4, 5, 6, 1, 2], 15));
// console.log("8",sostavChisla([7, 8, 3, 4, 5, 6, 1, 2], 8));
// console.log("8",sostavChisla([1, 2, 3, 4, 5, 6, 7, 8], 8));
// console.log("5",sostavChisla([8, 2, 3, 4, 6, 7, 1], 5));
